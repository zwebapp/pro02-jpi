...
<div class="wrapper">
  ...
  <div class="pull-left info">
    ...
    <div class="control-group {{ ($errors->has('firstname') ? 'error' : '' ) }}">
      <div class="control">
        {{ Form::text('firstname', '', ['class' => 'input-xlarge', 'placeholder' => 'Firstname'] ) }}
    ...
    <div class="control-group {{ ($errors->has('birthday') ? 'error' : '' ) }}">
      <div class="control">
        {{ Form::text('birthday', '', ['class' => 'input-xlarge', 'data-mask' => '99-99-9999', 'placeholder' => 'Data of Birth: MM-DD-YYYY'] ) }}
        <span class="help-block">{{ $errors->first('birthday') }}</span>
      </div>
    </div>
    <div class="control-group {{ ($errors->has('address') ? 'error' : '' ) }}">
      <div class="control">
        {{ Form::textarea('address', '', ['class' => 'input-xlarge', 'placeholder' => 'Mailing address', 'rows' => '2'] ) }}
